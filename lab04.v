...
module lab04 (
  ...
  assign s14[1:0] = const2b0;
  assign s14[33:2] = signEX;
  // alu
  alu alu_i2 (
    .alu_control( 4'b10 ),
    .A( PC_temp ),
  ...
  assign opcode_temp = s13[31:26];
  assign src1_addr_temp = s13[25:21];
  assign src2_addr_temp = s13[20:16];
  assign s2 = s13[15:11];
  assign s1 = s13[15:0];
  assign s11 = adder[7:0];
  // control_unit
